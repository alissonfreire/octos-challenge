...
#
#     PHX_SERVER=true bin/octos_challenge start
#
...
if config_env() == :prod do
  ...
  config :octos_challenge, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :octos_challenge, OctosChallenge.Mailer,
